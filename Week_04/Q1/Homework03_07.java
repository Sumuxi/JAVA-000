...
public class Homework03_07 {
	...
	static class MyThread extends Thread {
		...
		public MyThread(Thread main, Method method) {
			this.main = main;
			this.method = method;
		}
...
//        int result = sum(); //这是得到的返回值
		...
		//使用LockSupport提供的park()和unpark(thread)方法
		try {
			final Method method = Homework03_07.class.getDeclaredMethod("sum");
			method.setAccessible(true);
			MyThread t = new MyThread(Thread.currentThread(), method);
			t.start();
