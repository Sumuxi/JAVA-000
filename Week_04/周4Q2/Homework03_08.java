...
public class Homework03_08 {
		...
		public void run() {
			try {
				...
				try {
					...
					Homework03_08.completed.signal();;
		        } finally {
		            lock.unlock();
		        }
	...
	public static Condition completed  = lock.newCondition();
...
//        int result = sum(); //这是得到的返回值
		...
		//利用显示锁Lock的await/signal机制
		try {
			final Method method = Homework03_12.class.getDeclaredMethod("sum");
